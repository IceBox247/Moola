...
export const game = {
  ...
  atfBoost: {
    ...
    // multipliers demand real holdings — e.g. 64× needs $2.5k of ATF, not $100.
    // Thresholds were lowered 4× from the original schedule to make the boost
    // easier to reach at current ATF prices.
    tiers: [
      { minUsd: 0.125, maxUsd: 0.175, mult: 2 },
      { minUsd: 0.175, maxUsd: 0.25, mult: 4 },
      { minUsd: 0.25, maxUsd: 0.325, mult: 6 },
      { minUsd: 0.325, maxUsd: 0.45, mult: 8 },
      { minUsd: 0.45, maxUsd: 0.625, mult: 10 },
      { minUsd: 0.625, maxUsd: 0.875, mult: 12 },
      { minUsd: 0.875, maxUsd: 1.25, mult: 14 },
      { minUsd: 1.25, maxUsd: 1.625, mult: 16 },
      { minUsd: 1.625, maxUsd: 2.25, mult: 18 },
      { minUsd: 2.25, maxUsd: 3, mult: 20 },
      { minUsd: 3, maxUsd: 4.25, mult: 22 },
      { minUsd: 4.25, maxUsd: 5.75, mult: 24 },
      { minUsd: 5.75, maxUsd: 8, mult: 26 },
      { minUsd: 8, maxUsd: 11, mult: 28 },
      { minUsd: 11, maxUsd: 15, mult: 30 },
      { minUsd: 15, maxUsd: 21.25, mult: 32 },
      { minUsd: 21.25, maxUsd: 28.75, mult: 34 },
      { minUsd: 28.75, maxUsd: 38.75, mult: 36 },
      { minUsd: 38.75, maxUsd: 53.75, mult: 38 },
      { minUsd: 53.75, maxUsd: 75, mult: 40 },
      { minUsd: 75, maxUsd: 102.5, mult: 42 },
      { minUsd: 102.5, maxUsd: 140, mult: 44 },
      { minUsd: 140, maxUsd: 193.75, mult: 46 },
      { minUsd: 193.75, maxUsd: 267.5, mult: 48 },
      { minUsd: 267.5, maxUsd: 367.5, mult: 50 },
      { minUsd: 367.5, maxUsd: 506.25, mult: 52 },
      { minUsd: 506.25, maxUsd: 697.5, mult: 54 },
      { minUsd: 697.5, maxUsd: 960, mult: 56 },
      { minUsd: 960, maxUsd: 1320, mult: 58 },
      { minUsd: 1320, maxUsd: 1818.75, mult: 60 },
      { minUsd: 1818.75, maxUsd: 2500, mult: 62 },
      { minUsd: 2500, maxUsd: Infinity, mult: 64 },
    ],
  },
